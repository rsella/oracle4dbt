...
class TestSimpleSeedColumnOverridePostgres(TestSimpleSeedColumnOverride):
    ...
    def oracle_profile(self):
        oracle_profile = super().oracle_profile()
        # override date format matching seeds
        oracle_profile['test']['outputs']['default2']['nls_date_format'] = 'YYYY-MM-DD HH24:MI:SS'
    ...
    def seed_tricky_types(self):
        return {
            'id_str': 'varchar2(30 char)',
            'looks_like_a_bool': 'varchar2(30 char)',
            'looks_like_a_date': 'varchar2(30 char)',
        }
        # return {
        #     'id_str': 'text',
